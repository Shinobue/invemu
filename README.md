...
| Left/Right arrow key | Move left/right (works for both player 1 & 2) |
| SPACE                | Fire                                          |
...
## Installation
If you're on 64-bit Windows, download the invemu.zip archive on the releases page. Create a folder in your preferred directory, and unzip the zip archive inside said folder. Put your game ROMs in the ROM folder, and sounds in the Sounds folder if you want sound. Run invemu.exe.
Alternatively, you can follow the build instructions and create the .exe yourself.

If you're on another platform, you will need to build the project yourself. I'm on Windows so I do not have an .exe file for other platforms.
...
## License
This project is free (libre & gratis) software licensed under the GPL, version 3. Any and all use of the files/code provided in this repository is bound by the terms therein.
...
- [superzazu's Intel 8080 implementation](https://github.com/superzazu/8080), which was immensely useful for output comparison when trying to fix my auxiliary carry.
